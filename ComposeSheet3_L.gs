...
//           //   openElementRecur(data[i]);
//           // }
//           // else result += openElement(data[i], true);
//           result += openElement(data[i], true);
//         }
//         typeName = data[i][1];
...
// // const openElementRecur = el => {
// //   const elArr = el[1].split("/");
  
// //   const recur = (elArr, i) => {
// //     // console.log("RECUR : " + [el[0], elArr[i], el[2], el[3], el[4], el[5]]);
// //     if (i === elArr.length) return;
// //     result += openElement([el[0], elArr[i], el[2], el[3], el[4], el[5]], true);
// //     recur(elArr, ++i);
// //   };
